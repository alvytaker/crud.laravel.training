...
@section('body')
 <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Usuarios QueryPDO</h1>
        </div>
      </div>
    </div>
...
@include('usuarios/ModalQueryPDO/ModalAdd')
</center>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table id="datatableCliente" class="table table-bordered table-hover">
                        ...
                        @include('usuarios/ModalQueryPDO/ModalEdit')
                        @include('usuarios/ModalQueryPDO/ModalDelete')
